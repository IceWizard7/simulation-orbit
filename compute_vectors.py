...
fix_code: dict[str, str] = {
    "Mercury": "5, (Color){150, 150, 150, 255}, 40'000",
    "Venus": "5, (Color){245, 190,  70, 255}, 30'000",
    "Earth": "5, (Color){ 40, 120, 204, 255}, 20'000",
    "Mars": "10, (Color){220,  60,  40, 255}, 15'000",
    "Jupiter": "10, (Color){220, 150,  85, 255}, 4'000",
    "Saturn": "10, (Color){235, 205, 120, 255}, 4'000",
    "Uranus": "10, (Color){ 80, 220, 220, 255}, 4'000",
    "Neptune": "10, (Color){ 40,  80, 230, 255}, 4'000",
    "Pluto": "10, (Color){185, 155, 130, 255}, 4'000",
}

sun: str = "CelestialBody sun   = {\"Sun\", {0, 0, 0}, {0, 0, 0}, 1.98847e30, 10, (Color){255, 230,  40, 255}, 30'000};"
