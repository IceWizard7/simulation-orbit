...
def fetch_vectors(start_date: datetime.date) -> tuple[list[str], list[Vec3]]:
    ...
    fix_code: dict[str, str] = {
        ...
        "Moon": "5, 0.01, (Color){200, 200, 200, 255}, 27.322 * 86'400",
        "Phobos": "5, 0.01, (Color){105, 93, 82, 255}, 0.3189 * 86'400",
        "Deimos": "5, 0.01, (Color){139, 118, 99, 255}, 1.2624 * 86'400",
        "Io": "5, 0.01, (Color){240, 197, 79, 255}, 1.7691 * 86'400",
        "Europa": "5, 0.01, (Color){210, 199, 174, 255}, 3.5512 * 86'400",
        "Ganymede": "5, 0.01, (Color){139, 126, 112, 255}, 7.1546 * 86'400",
        "Callisto": "5, 0.01, (Color){76, 66, 60, 255}, 16.689 * 86'400",
